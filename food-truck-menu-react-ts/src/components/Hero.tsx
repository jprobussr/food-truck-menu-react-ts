  ...
  return (
    <section className="hero">
      <div className="hero__content">
        <p className="hero__eyebrow">Street Food • Late Night • Fresh Flavor</p>
        <h1>Midnight Bites Food Truck</h1>
        <p className="hero__text">
          Bold street food served fresh from the truck, made for night markets,
          weekend cravings, and quick lunches with serious flavor.
        </p>
